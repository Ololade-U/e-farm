...
-- CreateEnum
CREATE TYPE "PostType" AS ENUM ('Vegetable', 'Fruit', 'Grain', 'Livestock', 'Dairy');

-- CreateEnum
CREATE TYPE "MeasureUnit" AS ENUM ('Kg', 'Litre', 'Unit', 'Crate', 'Bag', 'Bunch');

-- CreateEnum
CREATE TYPE "Status" AS ENUM ('OnSale', 'SoldOut', 'Inactive');
